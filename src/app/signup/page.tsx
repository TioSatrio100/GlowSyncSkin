      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-2xl shadow-xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-secondary-400">
            ...
            <Link href="/signin" className="font-medium text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-500 hover:from-primary-700 hover:to-secondary-600">
              Sign in
            </Link>
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6">
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="first-name" className="block text-sm font-medium text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-500">
                  First name
                </label>
                <div className="mt-1">
                  <input
              ...
              <div>
                <label htmlFor="last-name" className="block text-sm font-medium text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-500">
                  Last name
                </label>
                <div className="mt-1">
                  <input
            ...
            <div>
              <label htmlFor="confirm-password" className="block text-sm font-medium text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-500">
                Confirm password
              </label>
              <div className="mt-1">
                <input
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="terms" className="ml-2 block text-sm text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-secondary-400">
              I agree to the{" "}
              <Link href="/terms" className="font-medium text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-500 hover:from-primary-700 hover:to-secondary-600">
                Terms of Service
              </Link>{" "}
              and{" "}
              <Link href="/privacy" className="font-medium text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-500 hover:from-primary-700 hover:to-secondary-600">
                Privacy Policy
              </Link>
            </label>
          </div>
