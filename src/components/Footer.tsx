    ...
    <footer className="bg-gray-900">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link href="/categories" className="text-base text-gray-300 hover:text-white">
                  Categories
                </Link>
              </li>
              <li>
                <Link href="/new-arrivals" className="text-base text-gray-300 hover:text-white">
                  New Arrivals
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-base text-gray-300 hover:text-white">
                  Facebook
                </a>
              </li>
              <li>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-base text-gray-300 hover:text-white">
                  Instagram
                </a>
              </li>
              <li>
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-base text-gray-300 hover:text-white">
                  Twitter
                </a>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-800 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">&copy; {new Date().getFullYear()} GlowSync. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
